...
<div class="container p-3 overflow-hidden">
    <div class="row d-sm-flex">
        <div class="p-5 col">
            <p class="display-4 text-center fw-bold">Users</p>
        </div>
    </div>
</div>
    ...
    <div aria-live="polite" aria-atomic="true" class="d-flex justify-content-center align-items-center py-3 w-100">
        <div class="comment" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="toast-header">
                ...
                <strong class="me-auto"><?= $user[0] ?></strong>
                <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Закрыть"
                        onclick="document.location='../vendor/delete_user.php?id=<?= $user[0] ?>'">
                </button>
            </div>
            <div class="toast-body">email: <?= $user[1] ?> <br> password: <?= $user[2] ?></div>
        </div>
    </div>
    <?php
}
