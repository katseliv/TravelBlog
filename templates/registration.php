...
<div class="container p-5 overflow-hidden">
    <div class="container w-25">
        <form class="" method="post" action="../vendor/sign_up.php">
            ...
            <div class="form-floating mb-3">
                <input type="password" class="form-control" name="password_confirm" id="pass"
            ...
            <button class="btn btn-lg btn-success w-100" type="submit">Sign Up</button>
            <p class="mt-3 mb-3 text-center">Already have an account?
                <a class="text-dark" href="authorization.php">Sign In!</a>
            </p>
        </form>
    </div>
</div>
